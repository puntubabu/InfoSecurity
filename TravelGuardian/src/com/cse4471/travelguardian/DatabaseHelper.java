...
public class DatabaseHelper {
    private static final String DATABASE_NAME = "TravelGuardian.db";
...
public DatabaseHelper(Context context) {
    ...
    TravelGuardianOpenHelper openHelper = new TravelGuardianOpenHelper(this.context);
...
private static class TravelGuardianOpenHelper extends SQLiteOpenHelper {
	TravelGuardianOpenHelper(Context context) {
